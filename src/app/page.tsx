      ...
      <div
        ...
        style={{
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black to to-transparent p-8 flex flex-col justify-end">
            ...
            <div className="mt-4">
              <Link href={`/movie/${featuredMovies.id}`}><button className="bg-red-600 text-white px-6 py-2 rounded-lg text-lg font-semibold hover:bg-red-700">Тоглуул</button></Link>
            </div>
          </div>
        </div>)}
        {/* movies list */}
